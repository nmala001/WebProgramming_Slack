...
function updateArchiveUnarchiveChannel(){
  
 var cid = $( "#channelName option:selected" ).val();
 var arch_unarch = $( "#archive_unarchive option:selected" ).val();
 console.log(arch_unarch);
           if (cid == "0" || cid == null) 
                       {
                           alert("Please Select Channel Name");
                       } else if(arch_unarch == "3" || arch_unarch == null)
                       {
                         alert("Please Select to Archive or Un-Archive the channel");
                       } else{
                   $.ajax({
                               type: "post",
                               url: "services/update_archive_unarchive_channel.php",
                               data: "cid=" +cid+"&archUnarch=" +arch_unarch,
    ...
    <div class="panel-group" >
        ...
        <div class="panel panel-primary"  >
            <div class="panel-heading" style="color:white"> 
                  <h3 align="center"><b>Archive/Unarchive Channel</b></h3>
            </div>
                      ...
                      <div class="form-group ">
                          <label class ="control-label col-sm-5"  for="archive_unarchive"> Archive/Unarchive </label>
                          <div  class ="col-sm-7">
                              <div class="dropdown">
                                   <!-- Select Users -->
                                 <select id="archive_unarchive" style="background-color:#e6e6e6;color:black" name="cars">
                                        <option value="3">Select</option>
                                        <option value="1">Archive</option>
                                        <option value="0">Un-Archive</option>
                                 </select> <!-- Select Users -->
                              </div>
                        </div>
                      </div>
                      <div class="form-group ">
                          ...
                          <div  class ="col-sm-6">
                              <button type="button" onclick="updateArchiveUnarchiveChannel()" class="btn btn-success">Submit</button>
                        </div>
                      </div>
